    ...
    return(
        <div className="mt-4">
            ...
            <div className="space-x-1 text-md">
                <ShinyText text="👨🏻‍💻 Jr Software Engineer" disabled={false} speed={3} className="custom-class" />
                <ShinyText text="| UI Developer" disabled={false} speed={3} className="custom-class" />
            </div>
